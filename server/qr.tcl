...
proc Start_Server {fpga} {
   ...
   puts stderr "<h4>Agora digite: ./remote $h $port </h4>"
   flush stderr
   vwait forever
}
...
# 00100011     12      RISC-V pc, instruction, SrcA, SrcB, ..., flags, and registers
...
#        if lcd_a and lcd_b are requested, get also led and seg
         } elseif { [string range $cmd 0 3] == "0011"} then {
            puts $sock "[get_data "00111110"][get_data "00111101"][get_data "00111100"][get_data "00111011"][get_data "00111010"][get_data "00111001"][get_data "00111000"][get_data "00110111"][get_data "00110110"][get_data "00110101"][get_data "00110100"][get_data "00110011"][get_data "00110010"][get_data "00110001"][get_data "00110000"][get_data "00100001"][get_data "00100000"][get_data "00000000"]"
#              if pc is requested, get also instruction up to flags, registers, led and seg
         } elseif { [string range $cmd 0 7] == "00100011" } then {
            puts $sock "[get_data "00100111"][get_data "00100110"][get_data "00100101"][get_data "00100100"][get_data "00101000"][get_data "00101001"][get_data "00101010"][get_data "00101011"][get_data "00101100"][get_data "00101101"][get_data "00101110"][get_data "00000000"][get_data "00000001"][get_data "00000010"][get_data "00000011"][get_data "00000100"][get_data "00000101"][get_data "00000110"][get_data "00000111"][get_data "00001000"][get_data "00001001"][get_data "00001010"][get_data "00001011"][get_data "00001100"][get_data "00001101"][get_data "00001110"][get_data "00001111"][get_data "00100001"][get_data "00100000"][get_data "00000000"]"
         } else {
